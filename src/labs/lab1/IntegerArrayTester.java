...
final class IntegerArray {
    ...
    public IntegerArray concat(IntegerArray ia) {
        int[] arrayToReturn = new int[ia.array.length + this.array.length];
        System.arraycopy(array, 0, arrayToReturn, 0, array.length );
        System.arraycopy(ia.array, 0, arrayToReturn, array.length,ia.array.length);
        return new IntegerArray(arrayToReturn);
    }
